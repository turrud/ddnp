        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\ProjectInterior::class)
                        <x-dropdown-link href="{{ route('project-interiors.index') }}">
                        Project Interiors
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\ProArchitectur::class)
                        <x-dropdown-link href="{{ route('pro-architecturs.index') }}">
                        Pro Architecturs
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\About::class)
                        <x-dropdown-link href="{{ route('abouts.index') }}">
                        Abouts
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Method::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\ProjectInterior::class)
                <x-responsive-nav-link href="{{ route('project-interiors.index') }}">
                Project Interiors
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\ProArchitectur::class)
                <x-responsive-nav-link href="{{ route('pro-architecturs.index') }}">
                Pro Architecturs
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\About::class)
